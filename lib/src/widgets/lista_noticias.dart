  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Container(
            child: (noticia.urlToImage != null && noticia.urlToImage!.contains('http'))
                ? FadeInImage(placeholder: const AssetImage('assets/img/giphy.gif'), image: NetworkImage(noticia.urlToImage!))
